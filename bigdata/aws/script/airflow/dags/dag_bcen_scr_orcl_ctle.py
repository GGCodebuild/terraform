...
prefix_athena = 'ATHENA_TEMP/bcen_scr_orcl/'
...
with DAG(
    ...
    vrfc_dag_exec = DagRunningOperator(
        ...
        target_dag_id='bcen_scr_orcl_ctle',
        task_true='exec',
        task_false='nao_exec'
    )
    ...
    exec_dag_emr = TriggerDagRunOperator(
        ...
        trigger_dag_id="bcen_scr_orcl_emr",
        wait_for_completion=True
    )

    exec_dag_glue = TriggerDagRunOperator(
        task_id='exec_dag_glue',
        trigger_dag_id="bcen_scr_orcl_glue",
        wait_for_completion=True
    )
